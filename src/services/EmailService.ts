...
export class EmailService {
  public async sendRewardCreditedEmail(email: string, name: string, amount: number, invoiceUrl?: string) {
  ...
  public async sendPaymentFailedEmail(email: string, name: string, amount: number, reason: string) {
    if (!process.env.RESEND_API_KEY) {
