import { User, Pickup, Reward, Payout, Campaign, Profile } from '../models/Schemas.js';
export const getDashboardStats = async (req, res) => {
    try {
        const [totalUsers, totalPickups, pendingPickups, totalRewardsPaid, activeCampaigns, pendingKyc, pendingPayouts, fraudAlerts] = await Promise.all([
            User.countDocuments(),
